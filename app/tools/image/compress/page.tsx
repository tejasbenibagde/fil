  ...
  const handleCompress = async () => {
    ...
    try {
      ...
      if (data.url) {
        ...
        throw new Error("No compressed image URL returned");
      }
    } catch (err) {
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="border rounded-lg overflow-hidden bg-muted/30 flex items-center justify-center h-48">
                    {preview && (
                      <NextImage
